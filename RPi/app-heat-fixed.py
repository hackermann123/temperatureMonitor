# Temperature Monitoring System - Flask Backend (v6.6 - FIXED PARSING)
        ...
        while self.running:
            ...
            try:
                ...
                for reading in readings:
                    ...
                    # VALIDATION: Check if this looks like a temperature reading (space or comma separated)
                    if any(sep in reading for sep in [" ", ","]) and not any(x in reading.upper() for x in ["ERROR", "WARN", "FAIL", "INFO"]):
                        ...
                        if len(parts) >= 2:
                            ...
                            # TEMPERATURE DATA VALIDATION - accept any hex string 8+ chars or numeric temp
...
def startup_sequence():
    ...
    print("[STARTUP] Initializing Temperature Monitoring System v6.6 WITH HEATER THERMISTOR + BETTER PARSING")
    ...
    print("[STARTUP] Parser: Accepts hex sensor IDs (8+ chars) with space or comma separator")
